...
<head>
    ...
    <title>Clearance Letter |Adeleke University</title>
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                          <div class="text-center article-title">
                            ...
                            <h1>
                                    ADELEKE UNIVERISTY, EDE <img src="<?php echo $rowaccess['photo']; ?>" width="157" height="175"></h1>
                          </div>
                            <p align="center" class="style1">CLEARANCE LETTER </p>
                            <p>&nbsp;</p>
                            <p>
                            HELLO THERE ADELEKITE <?php echo $rowaccess['fullname']; ?>, </p>
                            <p>&nbsp;</p>
                            ...
                            <p align="justify">&nbsp;</p>
                            <p align="justify">
                                This letter will allow you stay in the hostel, eat in the Cafetaria and any other facility you wish to use. we wish you best of luck.</p>
                            <p align="right" class="style2">
                                SIGNED</p>
                            <p align="right">&nbsp;</p>
                            <p align="right"><strong>REGISTRAR                            </strong></p>
                            <hr>
                            <div class="row">
